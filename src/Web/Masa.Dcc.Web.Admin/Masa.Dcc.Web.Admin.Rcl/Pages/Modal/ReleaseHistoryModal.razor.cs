...
public partial class ReleaseHistoryModal
{
    ...
    [Parameter] public bool ConfigValue { get; set; }

    [Parameter] public EventCallback<bool> ConfigValueChanged { get; set; }
    [Parameter] public ConfigObjectModel SelectConfigObject { get; set; } = new();

    [Inject] public IPopupService PopupService { get; set; } = default!;

    [Inject] public ConfigObjectCaller ConfigObjectCaller { get; set; } = default!;
