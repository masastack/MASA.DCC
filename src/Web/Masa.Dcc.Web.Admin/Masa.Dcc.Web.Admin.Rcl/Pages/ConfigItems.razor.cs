...
public partial class ConfigItems
{
    ...
    [Parameter]
    public ConfigObjectModel ConfigObject { get; set; } = default!;

    [Parameter]
    public EventCallback<ConfigObjectModel> ConfigObjectChanged { get; set; } = default!;

    [Parameter]
    public EventCallback<ConfigObjectModel> RevokeClick { get; set; }

    [Parameter]
    public EventCallback<ConfigObjectModel> RemoveClick { get; set; }

    [Parameter]
    public EventCallback<ConfigObjectModel> CancelEditConfigClick { get; set; }

    [Parameter]
    public EventCallback<ConfigObjectModel> UpdateConfigClick { get; set; }

    [Parameter]
    public EventCallback<ConfigObjectModel> CloneConfigClick { get; set; }

    [Parameter]
    public EventCallback<ConfigObjectModel> ReleaseConfigClick { get; set; }

    [Parameter]
    public EventCallback<ConfigObjectModel> RollbackClick { get; set; }
