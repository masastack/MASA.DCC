...
namespace Masa.Dcc.Service.Admin.Migrations
{
    ...
    [Migration("20220428095529_UpdateConfigObjectReleaseField")]
    partial class UpdateConfigObjectReleaseField
    {
            ...
            modelBuilder.Entity("Masa.Dcc.Service.Admin.Domain.App.Aggregates.ConfigObjectRelease", b =>
                {
                    ...
                    b.Property<int>("RollbackFromReleaseId")
                        .HasColumnType("int")
                        .HasComment("Rollback From Release Id");

                    b.Property<int>("RollbackToReleaseId")
                        .HasColumnType("int")
